...
//이메일인증~
    const btn = document.getElementById('join_proof');
    ...
    function proofcheckaction() {
		if (joinForm.proofcheck.value==proofnum&&proofnum!=0) {
			//joinForm.proofok.style.display = "inline";
			document.getElementById('proofok').innerHTML = "인증이 완료되었습니다.";
			joinForm.join_proofcheck_btn.style.display = "none";
			joinForm.proofcheck.style.display = "none";
