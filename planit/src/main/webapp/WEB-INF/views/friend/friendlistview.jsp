                        ...
                        <c:when test="${friendlsList != null and friendlsList.size()>0 }">
                           <%--  <c:set var="i" value="1"/>
                            ...
                            <c:forEach begin="0" end="${friendlsList.size() - 1}" var="i" step="1">
                                    <tr>
                                        <td><input type="text" id="friendid${i}" value="${friendlsList[i].userid}" readonly="readonly" style="text-align: center; font-size: 15px;"></td>
                                        <!-- el문 자체가 get -->
                                        <td><input type="text" id="username" value="${friendlsList[i].username}" readonly="readonly" style="text-align: center; font-size: 15px;"></td>
                                        <%-- <td><input type="checkbox" name="checkchat" id="checkchat" value="${friendlsList[i].userid}" style="text-align: center; font-size: 15px;"></td> --%>
                                        <td><input type="button" id="bad" value="차단하기" style= "text-align: center; font-size: 15px;" onclick="friendblock('${i}')"></td>
                                    </tr>
                            </c:forEach>
                        </c:when>
                    </c:choose>
